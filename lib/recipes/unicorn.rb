Capistrano::Configuration.instance.load do
  ...
  _cset :unicorn_config,      "#{configs_path}/unicorn.rb"
  ...
  _cset :unicorn_template,                "vendor/unicorn_template.rb.erb"
  _cset :unicorn_startup_script_template, "vendor/unicorn_startup_script_template.erb"
  _cset :startup_script_prefix,           "/etc/init.d"
  _cset :startup_script_name,             "unicorn_#{app_name}"
  ...
  _cset :monit_unicorn_template,          "vendor/monit_unicorn.conf.erb"
  _cset :monit_conf_prefix,               "/etc/monit/conf.d"
  _cset :monit_unicorn_conf_name,         "unicorn_#{app_name}.conf"
